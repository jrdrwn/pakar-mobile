...
class CreateKarya extends StatefulWidget {
  ...
  @override
  State<CreateKarya> createState() => _CreateKaryaState();
}

class _CreateKaryaState extends State<CreateKarya> {
      ...
      child: Padding(
        ...
        child: Column(children: [
          ...
          MenuAnchor(
              ...
              style: MenuStyle(
                maximumSize:
                    const MaterialStatePropertyAll(Size(double.maxFinite, 225)),
              ...
              : FilledButton.icon(
                  onPressed: () async {
                    ...
                    var response = await http.post(
                      Uri.parse('${dotenv.env["API_URL"]}/karya'),
                    ...
                    if (response.statusCode != 200) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text("Karya gagal dibuat"),
                        ),
                      );
                      return;
                    }
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text("Karya berhasil dibuat"),
                      ),
                    );
